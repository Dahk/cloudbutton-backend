...
import cloudbutton.multiprocessing as cb
from cloudbutton.cloud_proxy import os as cloudfs
from cloudbutton.multiprocessing.managers import SyncManager, BaseProxy
...
class CloudbuttonBackend(ParallelBackendBase, PoolManagerMixin):
    ...
    def configure(self, n_jobs=1, parallel=None, prefer=None, require=None,
        ...
        gc.collect()
        self._pool = cb.Pool()#initargs={'log_level': 'DEBUG'})
